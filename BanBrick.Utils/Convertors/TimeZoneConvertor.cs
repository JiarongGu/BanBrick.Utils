...
namespace BanBrick.Utils.Convertors
{
    ...
    /// https://github.com/zkweb-framework/ZKWeb/blob/master/ZKWeb/ZKWebStandard/Utils/LocaleUtils.cs 
    /// </summary>
    public static class TimeZoneConvertor
    {
        /// <summary>
        ...
        public static TimeZoneInfo GetTimezoneInfo(string timezone)
        {
            ...
            // Try converted
            timezone = WindowsToOlsonTimezoneMapping.GetOrDefault(timezone) ?? OlsonToWindowsTimezoneMapping.GetOrDefault(timezone);
